...
import 'package:my_store/data/services/storageServices/firebase_storage_service.dart';
...
class BrandsRepository extends GetxController {
  ...
  Future<List<BrandModel>> getBrandsForCategory(String categoryId) async {
    try {
      QuerySnapshot brandsCategoryQuery = await _db
          .collection("BrandCategory")
          .where('categoryId', isEqualTo: categoryId)
          .get();
      List<String> brandsId = brandsCategoryQuery.docs
