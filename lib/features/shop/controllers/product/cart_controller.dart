...
import 'package:my_store/features/shop/controllers/product/product_variation_controller.dart';
...
import 'package:my_store/utils/local_storage/storage_utility.dart';
    ...
    if (product.productType == ProductType.variable.toString()) {
      if (variationController.selectedVariation.value.stock < 1) {
        AppLoaders.warningSnackBar(
            message: "Selected Variaition is out of Stock", title: "Oh Snap!");
        return;
      }
    } else {
      if (product.stock < 1) {
