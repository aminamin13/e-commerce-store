...
import 'package:my_store/data/repositories/banners/banners_repository.dart';
import 'package:my_store/data/repositories/brands/brands_repository.dart';
import 'package:my_store/data/repositories/categories/categories_repositories.dart';
import 'package:my_store/data/repositories/dummy_class.dart';
import 'package:my_store/data/repositories/products/product_repository.dart';
import 'package:my_store/data/repositories/relational/upload_relational.dart';
...
class UploadDataController extends GetxController {
  ...
  Future<void> upLoadDummyCategories() async {
    try {
      ...
      AppLoaders.successSnackBar(
          title: "Success", message: "Dummy categories uploaded successfully!");
    } catch (e) {
  ...
  Future<void> upLoadDummyBanners() async {
    try {
      ...
      // Show success message
      AppLoaders.successSnackBar(
          title: "Success", message: "Dummy Banners uploaded successfully!");
    } catch (e) {
      AppLoaders.errorSnackBar(title: "Error", message: e.toString());
    } finally {
      isLoading.value = false;
  ...
  Future<void> upLoadDummyBrands() async {
    try {
      ...
      // Show success message
      AppLoaders.successSnackBar(
          title: "Success", message: "Dummy Brands uploaded successfully!");
    } catch (e) {
      AppLoaders.errorSnackBar(title: "Error", message: e.toString());
    } finally {
      isLoading.value = false;
  ...
  Future<void> upLoadDummyBrandsCategory() async {
    try {
      ...
      // Upload dummy data to Firebase
      await _brandsCategoryProducts
          .uploadDummyBrandCategory(dummyBrandsCategoty);
  ...
  Future<void> upLoadDummyProductsCategory() async {
    try {
      ...
      // Upload dummy data to Firebase
      await _brandsCategoryProducts
          .uploadDummyProductCategory(dummyProductsCategoty);
