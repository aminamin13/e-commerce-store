...
import 'package:my_store/features/shop/controllers/product/all_product_controller.dart';
...
class AppSortableProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(
        AllProductsController()); // Use Get.find to get the existing controller
    ...
    return Column(
      children: [
        DropdownButtonFormField(
          ...
          items:
              ["Name", "Highest Price", "Lowest Price", "Most Recent", "Sale"]
